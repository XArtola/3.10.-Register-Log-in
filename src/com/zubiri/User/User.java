...
public class User {
	...
	/**
	 * There is a default user (UserName)
	 * With a default password (1234abcd=)
	 */
	public User() {
	}
	 ...
	 * @return  -2: invalid username, -1: invalid password, 0: succesfully registered, 1: invalid username and password
	 */
